...
import sys
sys.path.append('.')
from schemacomponent.component import executor
...
class SchemaCurationSpec(types.ComponentSpec):
    ...
    OUTPUTS = {
        'custom_schema': ChannelParameter(
            type=standard_artifacts.Schema
...
class SchemaCuration(base_component.BaseComponent):
    ...
    def __init__(
      ...
      schema_fn: Optional[Union[Text, data_types.RuntimeParameter]] = None):
        ...
        Args:
          schema: A dictionary that containes the schema generated by SchemaGen component of tfx
          custom_schema: A dictionary that contains the schema after curation by the custom schema curation component
        """

        custom_schema = types.Channel(type=standard_artifacts.Schema)

        spec = SchemaCurationSpec(
            schema=schema, custom_schema=custom_schema, module_file=module_file,module_path=module_path,schema_fn=schema_fn
        )
