...
_SLACKSPEC = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='slack_token',
            full_name='tfx_addons.slack_exit_handler.SlackSpec.slack_token',
            index=0,  # pylint: disable=line-too-long
            number=1,
            type=9,
            cpp_type=9,
            label=1,
            ...
            serialized_options=None,
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key),  # pylint: disable=line-too-long
        _descriptor.FieldDescriptor(
            name='slack_channel_id',
            full_name=
            'tfx_addons.slack_exit_handler.SlackSpec.slack_channel_id',
            index=1,  # pylint: disable=line-too-long
            number=2,
            type=9,
            cpp_type=9,
            label=1,
