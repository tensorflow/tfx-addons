...
_SLACKSPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='slack_token', full_name='tfx_addons.slack_exit_handler.SlackSpec.slack_token', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='slack_channel_id', full_name='tfx_addons.slack_exit_handler.SlackSpec.slack_channel_id', index=1,
