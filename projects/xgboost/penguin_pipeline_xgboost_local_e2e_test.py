...
class PenguinPipelineXGBoostLocalEndToEndTest(tf.test.TestCase):

  def setUp(self):
    super(PenguinPipelineXGBoostLocalEndToEndTest, self).setUp()
  ...
  def testPenguinPipelineXGBoostLocal(self):
    tfx.orchestration.LocalDagRunner().run(
        penguin_pipeline_xgboost_local._create_pipeline(
