...
"""Tests for penguin_pipeline_xgboost_gcp."""
...
import penguin_pipeline_xgboost_gcp


class PenguinPipelineXGBoostGcpTest(test_case_utils.TfxTest):

  def setUp(self):
    super(PenguinPipelineXGBoostGcpTest, self).setUp()
  ...
  def testPipelineConstruction(self, resolve_mock):
    ...
    logical_pipeline = penguin_pipeline_xgboost_gcp._create_pipeline(
    ...
    file_path = os.path.join(self.tmp_dir, 'xgboost_test.tar.gz')
